            ...
            <CarouselContent>
              {Array.from({ length: 15 }).map((_, index) => (
                <CarouselItem className="lg:basis-1/2" key={index}>
                  <div className="bg-zinc-100 rounded-md h-full lg:col-span-2 p-6 aspect-video flex justify-between flex-col dark:bg-zinc-800">
                    ...
                    <div className="flex flex-col gap-4">
                      <div className="flex flex-col">
                        ...
                        <p className="text-zinc-500 max-w-xs text-base dark:text-zinc-400">
