...
import { Menu, Tablets, ShoppingBag, ShieldPlus } from "lucide-react";
        ...
        <nav className="justify-between hidden lg:flex">
          <div className="flex items-center gap-6">
            <TransitionLink href="/" className="flex items-center gap-2">
              <span className="text-xl font-bold hover:text-neutral-700">Medica</span>
            </TransitionLink>
            <div className="flex items-center">
              <TransitionLink
                className={cn("text-muted-foreground", navigationMenuTriggerStyle, buttonVariants({ variant: "ghost" }))}
                href="/about"
              >
                About us
              </TransitionLink>
                        ...
                        {subMenuItemsOne.map((item, idx) => (
                          <li key={idx}>
                            <NavigationMenuLink asChild>
                              <Link
                                className={cn(
                                  "flex select-none gap-2 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-stone-100"
                                )}
                                href="#"
                              >
                                {item.icon}
          ...
          <div className="flex items-center gap-3">
            <TransitionLink
              className={cn("text-muted-foreground size-2", navigationMenuTriggerStyle, buttonVariants({ variant: "ghost" }))}
              href="/admin"
            >
              <ShieldPlus />
            </TransitionLink>
